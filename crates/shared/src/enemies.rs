...
/// Spawns wave enemies and returns their entities so the caller can attach
/// networking components (the server adds Replicate; tests add nothing).
pub fn spawn_wave(commands: &mut Commands, wave: u32, bounds: &ArenaBounds) -> Vec<Entity> {
